...
exports.PaymentInfosModule = void 0;
...
let PaymentInfosModule = class PaymentInfosModule {
};
exports.PaymentInfosModule = PaymentInfosModule;
exports.PaymentInfosModule = PaymentInfosModule = __decorate([
    (0, common_1.Module)({
        controllers: [controller_1.PaymentsInfosController],
        providers: [
            service_1.PaymentInfoService,
